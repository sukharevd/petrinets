...
public class TreeConnection {
	...
	/**
	 * @param nameVhod - sets the name of entrance
	 */
	...
	/**
	 * @param nameVihod - sets the name of exit
	 */
    ...
    /**
     * @param id - number of real entrance
     */
