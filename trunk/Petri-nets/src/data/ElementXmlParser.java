	...
	public void startElement(String namespaceURI, String localName, String qName, Attributes attrs) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null,
                    "Wrong argument of " + qName + " node while parsing.", "Error of parsing",
                    JOptionPane.ERROR_MESSAGE);
          return;
        } catch (arcXYSizeException e) {
            JOptionPane.showMessageDialog(null,
                    "Wrong set of X and Y in Arc node while parsing.", "Error of parsing",
                    JOptionPane.ERROR_MESSAGE);
          return;
        } catch (WrongQNameException e) {
            JOptionPane.showMessageDialog(null,
                    "Wrong node (" + qName + ") while parsing.", "Error of parsing",
                    JOptionPane.ERROR_MESSAGE);
          return;
        }
